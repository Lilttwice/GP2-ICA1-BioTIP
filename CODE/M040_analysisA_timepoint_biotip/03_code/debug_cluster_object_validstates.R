clusters <- readRDS("CODE/M040_analysisA_timepoint_biotip/04_output/analysisA_clusters_validstates.rds")
...
writeLines(lines, "CODE/M040_analysisA_timepoint_biotip/04_output/analysisA_cluster_object_validstates_debug.txt")
message("Valid-state cluster object debug saved.")
